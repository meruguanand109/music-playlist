...
class App extends Component {
  ...
  onClickDelete = name => {
    ...
    const filteredPlayList = playList.filter(each => each.name !== name)
    this.setState({playList: filteredPlayList})
  }

  renderSongsView = () => {
    const {playList, searchInput} = this.state
    const filteredPlayList = playList.filter(each =>
    ...
    return (
      <div className="main-container">
        <div className="banner-section">
          <h1 className="h">Ed Sheeran</h1>
          <p className="p">Singer</p>
        </div>
        <div className="content-container">
          <div className="row">
            <h1 className="content-p">Songs Playlist</h1>
